...
router.get('/programmers', function(req, res, next) { 
  res.render('server', {
    title: "Сервер с программистами",
    picture: "images/programmers.jpg",
...
router.get('/future', function(req, res, next) { 
  res.render('server', {
    title: "Сервер в будущем",
    picture: "images/future.jpg",
